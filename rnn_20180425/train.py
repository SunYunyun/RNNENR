...
# -*- coding: utf-8 -*-
# 代码
# model.train(train, dev, vocab_tags) ---训练
# model.evaluate(test, vocab_tags) --评价
# model.interactive_shell(vocab_tags, processing_word) --预测
# 分别表示训练，评价，推理（预测），训练的时候将评价、推理注释，如果预测需将训练、评价注释
